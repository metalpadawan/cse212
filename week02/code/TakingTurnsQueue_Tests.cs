...
public class TakingTurnsQueueTests
{
    ...
    // Defect(s) Found: New people were added to the front of the queue instead of the back, causing LIFO behavior instead of FIFO behavior.
    ...
    // Defect(s) Found: New people were added to the front of the queue instead of the back, including when a person was added midway.
    ...
    // Run 10 times.
    // Expected Result: Bob, Tim, Sue, Bob, Tim, Sue, Tim, Sue, Tim, Tim
    // Defect(s) Found: People with 0 turns were not re-added to the queue forever as required.
    ...
    // Defect(s) Found: People with negative turns were not re-added to the queue forever as required.
